...
public class App {
    public static void main( String[] args ) {
        ...
        try (PrintWriter out = new PrintWriter(new FileWriter(outputFile, false))) {
            ...
            Restaurant restaurant = new Restaurant(logger,stats);
            Cuisinier cuisinier = new Cuisinier(restaurant);
            Thread threadCuisinier = new Thread(cuisinier);
