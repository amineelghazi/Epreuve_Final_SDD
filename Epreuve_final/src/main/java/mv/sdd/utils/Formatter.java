...
public final class Formatter {
    ...
    public static String clientLine(Client client, MenuPlat codePlat) {
        String platEmoji = (codePlat != null) ? emojiPlat(codePlat) : "N/A";
        return "#" + client.getId() + " " + client.getNom() + " " + emojiEtatClient(client.getEtat()) + " (pat=" + client.getPatience() + ", " + platEmoji + ")";
    }
